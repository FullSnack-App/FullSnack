...
const OrderSuccess = () => {
    ...
    return (
        <div className="min-h-screen flex flex-col items-center justify-center bg-gray-100 py-10 px-4">
            <div className="bg-white rounded-2xl shadow-lg p-10 text-center max-w-3xl w-full">
                ...
                {/* 🧾 Invoice Card */}
                <div className="bg-gray-50 border border-gray-200 rounded-xl p-8 text-left shadow-sm mb-6">
