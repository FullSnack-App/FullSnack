        ...
        try {
            ...
            if (mode === 'add') {
                ...
                const populatedOffer = {
                    ...savedOffer,
                    menuItems: menuItems.filter((m) => (offerData.menuItems || []).includes(m._id)),
                };
                ...
                setOffers((prev) => prev.map((o) => (o._id === updated._id ? populatedOffer : o)));
                        ...
                        <button
                            ...
                            onClick={async () => {
                                try {
                                    ...
                                    toast.success(
                                        `Offer ${actionText.toLowerCase()}d successfully!`
                                    );
                                } catch (err) {
                                    console.error(err);
